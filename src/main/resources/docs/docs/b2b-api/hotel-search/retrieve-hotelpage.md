...
source: https://docs.emergingtravel.com/docs/b2b-api/hotel-search/retrieve-hotelpage/
tags:
- etg-docs
- b2b-api
- hotel-search
title: Retrieve hotelpage
---
...
Whether all available early check-ins or check-outs for the rate are needed or not.
