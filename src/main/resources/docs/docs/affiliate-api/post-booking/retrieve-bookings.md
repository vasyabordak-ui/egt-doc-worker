...
source: https://docs.emergingtravel.com/docs/affiliate-api/post-booking/retrieve-bookings/
tags:
- etg-docs
- affiliate-api
- post-booking
...
The partner UTM term.

partner\_extra\_cookie
String

The partner extra cookies.
